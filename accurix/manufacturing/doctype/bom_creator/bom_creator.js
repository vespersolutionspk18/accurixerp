...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "accurix.controllers.queries.item_query";
		dialog.show();
	},
...
accurix.bom.BomConfigurator = class BomConfigurator extends accurix.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new accurix.bom.BomConfigurator({ frm: cur_frm }));
