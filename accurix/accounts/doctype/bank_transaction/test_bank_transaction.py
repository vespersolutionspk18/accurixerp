...
from accurix.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool import (
	get_linked_payments,
	reconcile_vouchers,
)
...
class TestBankTransaction(IntegrationTestCase):
	...
	# This test checks if accurix is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if accurix can correctly filter a linked payments based on the debit/credit amount
