...
import accurix
from accurix.accounts.doctype.accounting_dimension.accounting_dimension import get_dimensions
from accurix.accounts.doctype.bank_account.bank_account import (
	get_bank_account_details,
	get_default_company_bank_account,
	get_party_bank_account,
)
from accurix.accounts.doctype.invoice_discounting.invoice_discounting import (
	get_party_account_based_on_invoice_discounting,
)
from accurix.accounts.doctype.journal_entry.journal_entry import get_default_bank_cash_account
...
from accurix.accounts.party import complete_contact_details, get_party_account, set_contact_details
...
from accurix.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from accurix.accounts.doctype.advance_taxes_and_charges.advance_taxes_and_charges import (
			AdvanceTaxesandCharges,
		)
		from accurix.accounts.doctype.payment_entry_deduction.payment_entry_deduction import (
			PaymentEntryDeduction,
		)
		from accurix.accounts.doctype.payment_entry_reference.payment_entry_reference import (
	...
	def update_payment_requests(self, cancel=False):
		from accurix.accounts.doctype.payment_request.payment_request import (
	...
	def build_gl_map(self):
		...
		company_currency = accurix.get_company_currency(self.company)
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or accurix.get_company_currency(ref_doc.company)
