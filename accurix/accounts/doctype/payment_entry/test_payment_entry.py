...
from accurix.accounts.doctype.payment_entry.payment_entry import (
...
from accurix.accounts.doctype.sales_invoice.test_sales_invoice import (
	create_sales_invoice,
	create_sales_invoice_against_cost_center,
)
from accurix.selling.doctype.sales_order.test_sales_order import make_sales_order
from accurix.setup.doctype.employee.test_employee import make_employee
...
class TestPaymentEntry(IntegrationTestCase):
	...
	def test_payment_entry_retrieves_last_exchange_rate(self):
		from accurix.setup.doctype.currency_exchange.test_currency_exchange import save_new_records
