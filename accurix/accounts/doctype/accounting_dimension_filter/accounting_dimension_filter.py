...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from accurix.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from accurix.accounts.doctype.applicable_on_account.applicable_on_account import (
			ApplicableOnAccount,
		)
