...
from accurix.accounts.party import get_party_account_currency
from accurix.accounts.report.accounts_receivable.accounts_receivable import execute as get_ar_soa
from accurix.accounts.report.accounts_receivable_summary.accounts_receivable_summary import (
	execute as get_ageing,
)
from accurix.accounts.report.general_ledger.general_ledger import execute as get_soa
...
class ProcessStatementOfAccounts(Document):
	...
	if TYPE_CHECKING:
		...
		from accurix.accounts.doctype.process_statement_of_accounts_cc.process_statement_of_accounts_cc import (
			ProcessStatementOfAccountsCC,
		)
		from accurix.accounts.doctype.process_statement_of_accounts_customer.process_statement_of_accounts_customer import (
			ProcessStatementOfAccountsCustomer,
		)
		from accurix.accounts.doctype.psoa_cost_center.psoa_cost_center import PSOACostCenter
		from accurix.accounts.doctype.psoa_project.psoa_project import PSOAProject
...
def get_html(doc, filters, entry, col, res, ageing):
	...
	template_path = (
		"accurix/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts.html"
		if doc.report == "General Ledger"
		else "accurix/accounts/doctype/process_statement_of_accounts/process_statement_of_accounts_accounts_receivable.html"
	)
