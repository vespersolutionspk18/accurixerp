...
from accurix.controllers.taxes_and_totals import ItemWiseTaxDetail, get_itemised_tax
from accurix.regional.italy import state_codes
...
def prepare_and_attach_invoice(doc, replace=False):
	...
	invoice_xml = frappe.render_template(
		"accurix/regional/italy/e-invoice.xml",
