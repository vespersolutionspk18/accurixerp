...
class TransactionDeletionRecord(Document):
	...
	if TYPE_CHECKING:
		...
		from accurix.accounts.doctype.transaction_deletion_record_details.transaction_deletion_record_details import (
			TransactionDeletionRecordDetails,
		)
		from accurix.setup.doctype.transaction_deletion_record_item.transaction_deletion_record_item import (
