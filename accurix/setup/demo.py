...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "accurix")
	try:
		...
		capture("demo_data_creation_failed", "accurix", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "accurix")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "accurix")
	try:
...
def make_transactions(company):
	...
	from accurix.accounts.utils import FiscalYearError
