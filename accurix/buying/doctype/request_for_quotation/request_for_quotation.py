...
from accurix.accounts.party import get_party_account_currency, get_party_details
from accurix.buying.utils import validate_for_items
from accurix.controllers.buying_controller import BuyingController
from accurix.stock.doctype.material_request.material_request import set_missing_values
...
class RequestforQuotation(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from accurix.buying.doctype.request_for_quotation_item.request_for_quotation_item import (
			RequestforQuotationItem,
		)
		from accurix.buying.doctype.request_for_quotation_supplier.request_for_quotation_supplier import (
