...
accurix.maintenance.MaintenanceSchedule = class MaintenanceSchedule extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new accurix.maintenance.MaintenanceSchedule({ frm: cur_frm }));
