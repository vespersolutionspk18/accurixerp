...
def task(doc_name, from_doctype, to_doctype):
	from accurix.accounts.doctype.payment_entry import payment_entry
	from accurix.accounts.doctype.purchase_invoice import purchase_invoice
	from accurix.accounts.doctype.sales_invoice import sales_invoice
	from accurix.buying.doctype.purchase_order import purchase_order
	from accurix.buying.doctype.supplier_quotation import supplier_quotation
	from accurix.selling.doctype.quotation import quotation
	from accurix.selling.doctype.sales_order import sales_order
	from accurix.stock.doctype.delivery_note import delivery_note
	from accurix.stock.doctype.purchase_receipt import purchase_receipt
