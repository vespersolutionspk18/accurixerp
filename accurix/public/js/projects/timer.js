frappe.provide("accurix.timesheet");

accurix.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	accurix.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

accurix.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {
