...
class Quotation(SellingController):
	...
	if TYPE_CHECKING:
		...
		from accurix.crm.doctype.competitor_detail.competitor_detail import CompetitorDetail
		from accurix.selling.doctype.quotation_item.quotation_item import QuotationItem
		from accurix.setup.doctype.quotation_lost_reason_detail.quotation_lost_reason_detail import (
...
def create_customer_from_lead(lead_name, ignore_permissions=False):
	from accurix.crm.doctype.lead.lead import _make_customer
...
def create_customer_from_prospect(prospect_name, ignore_permissions=False):
	from accurix.crm.doctype.prospect.prospect import make_customer as make_customer_from_prospect
