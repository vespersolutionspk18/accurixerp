...
from accurix.accounts.party import get_due_date
from accurix.exceptions import PartyDisabled, PartyFrozen
from accurix.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	parse_full_name,
)
from accurix.tests.utils import create_test_contact_and_address
...
class TestCustomer(IntegrationTestCase):
	...
	def test_party_details(self):
		from accurix.accounts.party import get_party_details
	...
	def test_customer_credit_limit_after_submit(self):
		from accurix.controllers.accounts_controller import update_child_qty_rate
		from accurix.selling.doctype.sales_order.test_sales_order import make_sales_order
