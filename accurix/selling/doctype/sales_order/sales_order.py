...
from accurix.accounts.party import get_party_account
from accurix.controllers.selling_controller import SellingController
from accurix.manufacturing.doctype.blanket_order.blanket_order import (
	validate_against_blanket_order,
)
from accurix.manufacturing.doctype.production_plan.production_plan import (
...
from accurix.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from accurix.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from accurix.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from accurix.accounts.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_pick_list(source_name, target_doc=None):
	from accurix.stock.doctype.packed_item.packed_item import is_product_bundle
