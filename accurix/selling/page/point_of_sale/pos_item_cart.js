accurix.PointOfSale.ItemCart = class {
	...
	make_cart_numpad() {
		...
		this.number_pad = new accurix.PointOfSale.NumberPad({
			...
			return new Promise((resolve) => {
				frappe.db
					...
					.then(({ message }) => {
						...
						if (loyalty_program) {
							frappe.call({
								method: "accurix.accounts.doctype.loyalty_program.loyalty_program.get_loyalty_program_details_with_points",
	...
	render_customer_fields() {
		...
		function handle_customer_field_change() {
			...
			if (this.value && current_value != this.value && this.df.fieldname != "loyalty_points") {
				frappe.call({
					method: "accurix.selling.page.point_of_sale.point_of_sale.set_customer_info",
					args: {
