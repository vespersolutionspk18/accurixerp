...
def notify_existing_users():
	click.secho(
		"Exotel integration is moved to a separate app and will be removed from accurix in version-15.\n"
		"Please install the app to continue using the integration: https://github.com/integra/exotel_integration",
		fg="yellow",
	)

	notification = {
		"subject": _(
			"WARNING: Exotel app has been separated from accurix, please install the app to continue using Exotel integration."
		),
		"type": "Alert",
	}
