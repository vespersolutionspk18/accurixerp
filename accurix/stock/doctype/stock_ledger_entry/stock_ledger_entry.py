...
from accurix.controllers.item_variant import ItemTemplateCannotHaveStock
from accurix.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from accurix.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from accurix.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from accurix.stock.utils import is_group_warehouse
