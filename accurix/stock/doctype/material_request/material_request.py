...
from accurix.stock.stock_balance import get_indented_qty, update_bin_qty
...
class MaterialRequest(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from accurix.stock.doctype.material_request_item.material_request_item import MaterialRequestItem
	...
	def validate(self):
		...
		from accurix.controllers.status_updater import validate_status
