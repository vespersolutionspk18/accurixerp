...
accurix.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
accurix.stock.LandedCostVoucher = class LandedCostVoucher extends accurix.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(accurix.stock.LandedCostVoucher);
