...
# accurix - web based ERP (http://accurix.com)
...
from accurix.accounts.utils import get_stock_and_account_balance
...
from accurix.stock.stock_ledger import get_previous_sle, update_entries_after
from accurix.stock.tests.test_utils import StockTestMixin
from accurix.stock.utils import get_incoming_rate, get_stock_value_on, get_valuation_method
...
class TestStockReconciliation(IntegrationTestCase, StockTestMixin):
	...
	def test_backdated_stock_reco_future_negative_stock(self):
		...
		from accurix.stock.stock_ledger import NegativeStockError
