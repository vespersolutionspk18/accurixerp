...
from accurix.accounts.party import render_address
from accurix.controllers.accounts_controller import get_taxes_and_charges
from accurix.controllers.sales_and_purchase_return import get_rate_for_return
from accurix.controllers.stock_controller import StockController
from accurix.stock.doctype.item.item import set_item_default
from accurix.stock.get_item_details import get_bin_details, get_conversion_factor
from accurix.stock.utils import get_incoming_rate, get_valuation_method
...
class SellingController(StockController):
	...
	def set_missing_lead_customer_details(self, for_validate=False):
		...
		if customer:
			from accurix.accounts.party import _get_party_details
			...
			from accurix.crm.doctype.lead.lead import get_lead_details
	...
	def validate_items(self):
		...
		from accurix.controllers.buying_controller import validate_item_type
